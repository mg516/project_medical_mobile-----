Vue.component('essaydetailcharge', {
	template:
	`<div class="essaydetailBody">
		<div class="essayTitle">{{title}}</div>
		<div class="essayRemark">
			<div class="essayTime">46分钟前</div>
			<div class="essayAuthor">mader</div>
		</div>
		<div class="essayContent" :class="{'nopayed':!ifPay}">{{content}}</div>
		<div class="essayAskCharge" v-if="!ifPay">
			<div class="essayAskChargeText">还有更多精彩内容，请购买后继续阅读</div>
			<div class="essayAskChargeBar" @click="pay">购买 2.9元</div>
		</div>`,
	props: {
		// activeName: String,
		// showUnit: Boolean,
	...
	data() {
		return {
			title:'J Thromb Haemost：血清尿酸水平与复发性静脉血栓栓塞风险的关系',
