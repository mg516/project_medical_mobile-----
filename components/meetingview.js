Vue.component('meetingview', {
	template:
	`<div class="essaydetailBody">
		<div class="essayTitle">人物专访：{{title}}</div>
		<div class="essayRemark">
			<div class="essayTime">46分钟前</div>
			<div class="essayAuthor">mader</div>
		</div>
		<div class="meetingInfo">
			<div class="meetingInfoItem">会议时间：2020-10-12 至 2020-10-11</div>
			<div class="meetingInfoItem">会议地点：日本</div>
			<div class="meetingInfoItem">电话：2044-39424888</div>
			<div class="meetingInfoItem">传真：2044-39424888</div>
			<div class="meetingInfoItem">联系人：高老师</div>
			<div class="meetingInfoItem">邮箱：129418@163.com</div>
			<div class="meetingInfoItem">联系地址：东京大学</div>
			<div class="meetingInfoItem">联系地址：www.tianya.cn</div>
		</div>
